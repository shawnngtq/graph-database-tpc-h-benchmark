...
// Q3
MATCH (l:LINEITEM)-[:IS_PART_OF]->(o:ORDERS)-[:MADE_BY]->(c:CUSTOMER)
...
MATCH (l:LINEITEM)-[:IS_PART_OF]->(o:ORDERS)
...
MATCH (l:LINEITEM)-[:IS_PART_OF]->(o:ORDERS)-[:MADE_BY]->(c:CUSTOMER)-[:BELONG_TO]->(n:NATION)-[:IS_FROM]-(r:REGION)
WHERE r.R_NAME = 'ASIA' 
...
MATCH (l:LINEITEM)-[:IS_PART_OF]->(o:ORDERS)-[:MADE_BY]->(c:CUSTOMER)-[:BELONG_TO]->(n2:NATION) 
...
MATCH (l:LINEITEM)-[:IS_PART_OF]->(o:ORDERS)-[:MADE_BY]->(c:CUSTOMER)-[:BELONG_TO]->(n1:NATION)
...
// Q9
MATCH (l:LINEITEM)-[:SUPPLIED_BY]->(s:SUPPLIER) 
...
RETURN n.N_NAME AS nation, 
    ...
    sum(toFloat(l.L_EXTENDEDPRICE) * (1 -toFloat(l.L_DISCOUNT))-ps.PS_SUPPLYCOST * l.L_QUANTITY) AS amount;


// Q10
MATCH (l:LINEITEM)-[:IS_PART_OF]->(o:ORDERS)-[:MADE_BY]->(c:CUSTOMER)-[:BELONG_TO]->(n:NATION)
...
// Q13
MATCH (o:ORDERS)
OPTIONAL MATCH (o:ORDERS)-[:MADE_BY]->(c:CUSTOMER)
